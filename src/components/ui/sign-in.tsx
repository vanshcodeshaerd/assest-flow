          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              <div className="animate-element animate-delay-300">
                <label className="text-sm font-medium text-muted-foreground">{idLabel}</label>
                <GlassInputWrapper>
                  <input name={idName} type={idType} placeholder={`Enter your ${idLabel.toLowerCase()}`} className="w-full bg-transparent text-sm p-4 rounded-2xl focus:outline-none" />
                </GlassInputWrapper>
              </div>
              ...
              <button type="submit" className="animate-element animate-delay-600 w-full bg-foreground text-background py-4 rounded-2xl font-medium hover:scale-[1.02] active:scale-[0.98] transition-all">
                {actionText}
              </button>
            </form>
